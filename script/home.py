...
listUnused = ["单音轨", "画中画", "热门", "直播室", "爱", "92", "创新及人才", "云演艺", "雅克音乐", "电信导视", "嘉佳卡通", "家政频道",
              ...
              "麻辣体育", "绚影", "亲子趣学", "中录动漫", "中国体育", "健康养生", "SCTV6", "CETV4"]
...
def generateM3U8(file):
    ...
    title = f'#EXTM3U name="{name}"' + ' x-tvg-url="https://raw.githubusercontent.com/suzukua/epg/main/data/t.xml.gz" url-tvg="https://raw.githubusercontent.com/suzukua/epg/main/data/t.xml.gz"\n'
    file.write(title)
    for group in orders:
        k = group
        v = m[group]
